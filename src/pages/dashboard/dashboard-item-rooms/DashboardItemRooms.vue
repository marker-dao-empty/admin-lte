 ...
 * Components Modals
 */
import ItemRoomsCreate from '@/views/modals/item-rooms/ItemRoomsCreate'
import ItemRoomsShow from '@/views/modals/item-rooms/ItemRoomsShow'
import ItemRoomsEdit from '@/views/modals/item-rooms/ItemRoomsEdit'
import ItemRoomsDelete from '@/views/modals/item-rooms/ItemRoomsDelete'
/**
...
export default {
  ...
  methods: {
    ...mapActions('itemRooms', [
      'loadItems',
    ]),

    ...mapMutations('itemRooms', [
      'setCurrentPage',
    ]),
